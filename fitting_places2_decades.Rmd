...
source('fun/FitAndPlot_function_beta.R')
options(mc.cores = 4)
...
# model_d <- stan_model("./models/continuous_foi_student_t_dec.stan")
# 
...
# saveRDS(model_d, 'models/model_d.RDS')
...
model_d <-readRDS('models/model_d.RDS')
